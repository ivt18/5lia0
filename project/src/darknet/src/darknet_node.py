...
class DarknetNode:
    def __init__(self):
        ...
        # YOLO model
        self.cfg_path = MODEL_DIR + "yolov4-tiny-custom.cfg"
        self.data_path = MODEL_DIR + "person.data"
        self.weights_path = MODEL_DIR + "yolov4-tiny-custom.weights"
    ...
    def image_cb(self, data):
        ...
        try:
            ...
            detection = Bool()
            if detections_sorted and detections_sorted[0][1] >= MINIMUM_DETECTION_CONFIDENCE:
                detection.data = True
            else:
